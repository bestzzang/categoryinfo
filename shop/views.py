...
class ProductUploadView(LoginRequiredMixin, CreateView):
    ...
    model = Product
    fields = ['category', 'image', 'cname', 'pname', 'related_url', 'description', 'meta_description', 'slug', 'unit_price', 'stock', 'available_display', 'available_order']
...
class ProductUpdatedView(LoginRequiredMixin, UpdateView):
    ...
    redirect_field_name = 'redirect_to'
    model = Product
    fields = ['image','cname', 'pname', 'related_url', 'description', 'meta_description', 'slug', 'unit_price', 'stock',]
